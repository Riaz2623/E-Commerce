            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                         <form style="margin-left:400px;" class="form-horizontal" wire:submit.prevent="updateSale">
                            <div class="form-group">
                                <label class="col-md-4 control-lable" >Status</lable>
                            ...
                            <div class="form-group">
                                <label  class="col-md-4 control-lable" >Sale Date</lable>
                                <div  style="width:150px; " class="col-md-4" >
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-lable"></lable>
                                <div class="col-md-4">
