...
<div class="container">
    ...
    <div class=" main-content-area">
        ...
        <div class="row">
            ...
            <div class="billing-address">
                <p class="row-in-form">
                    <label for="finame">first name<span>*</span></label>
                    <input type="text" name="finame" value="" placeholder="Your name" wire:model="firstname">
    ...
    <div class="col-md-12">
            ...
            <div class="billing-address">
                <p class="row-in-form">
                    <label for="finame">first name<span>*</span></label>
                    <input type="text" name="finame" value="" placeholder="Your name" wire:model="s_firstname">
    ...
    @endif
        ...
        <div class="summary summary-checkout">
            <div class="summary-item payment-method">
                ...
                <div class="choose-payment-methods">
                    <label class="payment-method">
                        ...
                        <span class="payment-desc">Order Naw Pay on Delivery</span>
                    </label>
                    <label class="payment-method">
                ...
                @if(Session::has('checkout'))
                    <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">Tk-{{Session::get('checkout')['total']}}</span></p>
                @endif               
            ...
            <div class="summary-item shipping-method">
                ...
                <p class="summary-info"><span class="title">Fixed Tk-0</span></p>
